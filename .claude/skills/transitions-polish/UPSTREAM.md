...
- 저장소: https://github.com/Jakubantalik/transitions.dev — `skills/transitions-polish/`
...
diff -r /tmp/Jakubantalik-transitions.dev-*/skills/transitions-polish .claude/skills/transitions-polish
```
