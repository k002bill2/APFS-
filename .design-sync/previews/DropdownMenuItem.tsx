...
/* 항목 상태 3종 — 기본 / 비활성(권한 없음) / danger(삭제). 하이라이트는 bg-accent-surface 슬라이드. */
export function ActionItems() {
  return (
    <div style={stage}>
      <DropdownMenu open onOpenChange={() => {}}>
        <DropdownMenuTrigger className={TRIGGER}>행 메뉴</DropdownMenuTrigger>
        <DropdownMenuContent align="start" style={{ width: 236 }} onOpenAutoFocus={noAutoFocus}>
          ...
          <DropdownMenuItem disabled>해지 처리(권한 없음)</DropdownMenuItem>
