...
/* 라벨 — 우클릭한 행이 무엇인지 알려주는 구역 제목(11.5px caption, 클릭 대상 아님). */
export function LabeledRowMenu() {
  ...
  return (
    <div style={stage}>
      <ContextMenu>
        ...
        <ContextMenuContent style={{ width: 212 }} onOpenAutoFocus={noAutoFocus}>
          ...
          <ContextMenuLabel>내보내기</ContextMenuLabel>
