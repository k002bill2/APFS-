...
const columnDefs: ColDef<PermRow>[] = [
  ...
  /* 설명이 남는 폭을 흡수한다 — maxWidth 없는 유일한 컬럼 + FIT_GRID_WIDTH */
  { field: 'desc', headerName: '설명', width: 300, minWidth: 200, cellStyle: flexCenter, cellRenderer: (p: any) => <MT>{p.value}</MT> },
...
export function UserPermissionManage({ onNav }: { onNav?: (r: string) => void }) {
  ...
  return (
    <GridFrame
      ...
      tabs={<AdminTabs route="user-permission-manage" onNav={onNav} />}
