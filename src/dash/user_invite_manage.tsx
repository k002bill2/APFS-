/* 사용자 초대(운용사) — 관리형 리스트 페이지 (관리자 > 사용자·권한 관리 > 사용자 초대(운용사), route user-invite-gp).
   출처: S0_103_사용자초대_운용사.html(AFIT 공통관리 KRDS TO-BE) → APFS 디자인시스템으로 변형.
...
/* kebab(···) — 등록이 없는 리스트라 툴바 단독 + 푸터 폴백(apfs-grid). 로컬 복사본 */
