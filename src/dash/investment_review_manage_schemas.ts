...
export const COMPLIANCE_SCHEMA: PageSchema = parsePageSchema({
  ...
  fields: [
    ...
    { key: 'co', label: '투자기업', control: 'text', long: true, required: true },
    { key: 'bizno', label: '사업자번호', control: 'text' },
    { key: 'overseas', label: '해외기업', control: 'switch', options: OPT_YN },
    { key: 'founded', label: '창업일자', control: 'date' },
    { key: 'fdiv', label: '사업분야', control: 'select', options: OPT_FDIV },
    { key: 'fcon', label: '사업내용', control: 'text', long: true },
    ...
    { key: 'venture', label: '벤처인증 여부', control: 'switch', options: OPT_YN },
    { key: 'region', label: '소재지', control: 'select', options: OPT_REGION },
    { key: 'ob', label: '의무투자', control: 'switch', options: OPT_YN },
    { key: 'sm', label: '일정규모이하투자', control: 'radio', options: OPT_YN3 },
    { key: 'agf', label: '농식품경영체 여부', control: 'switch', options: OPT_YN },
    { key: 'follow', label: '후속투자여부', control: 'switch', options: OPT_YN },
